<p align="center">
  <img src="./assets/logo-devcouncil.png" width="140" height="140" alt="DevCouncil logo" />
</p>

<h1 align="center">DevCouncil</h1>
...
<p align="center">
  <img src="./assets/demo/main.webp" alt="DevCouncil workspace" width="800" />
</p>

<p align="center">
  <a href="https://github.com/bharathvbcr/DevCouncil">
    <img src="https://img.shields.io/badge/Repo-DevCouncil-red?style=flat-square&logo=github&logoColor=white" alt="DevCouncil repository" />
  </a>&nbsp;
  <a href="https://github.com/bharathvbcr/DevCouncil/releases/latest/download/DevCouncil-macOS.dmg">
  ...
  <a href="https://github.com/bharathvbcr/DevCouncil/releases/latest/download/DevCouncil-macOS-Intel.dmg">
  ...
  <a href="https://github.com/bharathvbcr/DevCouncil/releases/latest/download/DevCouncil-Windows-setup.exe">
  ...
  <a href="https://github.com/bharathvbcr/DevCouncil/releases/latest/download/DevCouncil-Linux.AppImage">
...
<p align="center">
  <a href="https://github.com/bharathvbcr/DevCouncil/releases">
    <img src="https://img.shields.io/github/v/release/bharathvbcr/DevCouncil?style=flat-square&label=Latest%20Release&color=B00020" alt="Latest Release" />
  </a>
</p>
...
DevCouncil is a native desktop environment for writing and revising technical documents without handing the whole workflow to a hosted editor. It combines a LaTeX editor, PDF preview, project templates, local project history, AI chat, Python tooling, and research-oriented skills in one Tauri app.
...
DevCouncil provides a CodeMirror-based LaTeX editor, BibTeX syntax support, real-time problem reporting, multi-file project navigation, PDF preview, zoom, text selection, and SyncTeX-style navigation between source and rendered output.
...
DevCouncil includes uv-based Python setup for project analysis and figure generation. A project-level `.venv` can be created from the app, then reused by assistant tools and scripts.
...
DevCouncil includes Zotero integration for bibliography workflows and citation insertion.
...
DevCouncil is local-first, not magic-air-gapped. Files are stored and compiled locally by default. If you enable a hosted AI provider, prompts and relevant project context can be sent to that provider. For fully local inference, configure Ollama and keep hosted model providers disabled.
...
Download the latest build from [GitHub Releases](https://github.com/bharathvbcr/DevCouncil/releases).
...
DevCouncil is built with Tauri 2, Rust, React, Vite, and TypeScript.
...
DevCouncil builds on the ideas and foundation of Claude Prism / Open Prism by [assistant-ui](https://github.com/assistant-ui), including the original local AI writing workspace direction. This project has been reworked under the DevCouncil brand with its own documentation, packaging, feature scope, and release path.
