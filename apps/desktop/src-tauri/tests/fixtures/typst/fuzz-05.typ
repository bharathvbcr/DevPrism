...
#set document(title: "अ_ — Resume", author: "अ_")
...
#{
doc-header("अ_", (")40%",), (("https://@", "@"),))
two-col({
sect("Skills")
skill-line(" #", "_#importअ#_$#let")
sect("Education")
entry("&́", "}", "(", "", "https://Senior Engineer}!\\")
bullets((
  rich(((false, ",^=#import:?$@ع&"),)),
))
extra(rich(((false, ".=̂"),)))
sect("Leadership")
entry("!~.-,", "*/", ".[{]```&", "", "https://```)word#")
extra(rich(((false, "word!"),)))
}, {
sect("Experience")
entry("$ x $=?ع^", " ", "", "中  ", "https://`!}*/")
bullets((
  rich(((false, "中+{é@\"́[;-́é=@preview"),)),
  rich(((false, "\"   \\+"),)),
))
})
}
