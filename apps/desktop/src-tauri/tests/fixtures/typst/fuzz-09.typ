...
#set document(title: "<̂- — Resume", author: "<̂-")
...
#{
doc-header("<̂-", ("#40%40%", ")", "a-"), (("https://#import^", "#import^"), ("https://中 #\\", "中 #\\"), ("https://\\", "\\")))
two-col({
sect("Skills")
skill-line("Senior Engineer अ", " //")
sect("Education")
entry("GPA 3.9中#import#let```", "", "\"́/*", "", "")
bullets((
  rich(((false, "/*//*/|[$ x $```(=~^"),)),
  rich(((false, "\""),)),
))
...
bullets((
  rich(((false, "🚀<$~́(\\ ~̂%}*/"),)),
  rich(((false, "-*/́#let%<@अ̂##import"),)),
  rich(((false, "́{\\#import ^+<́GPA 3.9b#let  \"^.-ع"),)),
))
extra(rich(((false, "+́"),)))
}, {
sect("Summary")
para(rich(((false, "]]$$ x $$ x $̂#let//:/GPA 3.9@preview=中"),)))
})
}
