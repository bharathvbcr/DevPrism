...
#set document(title: "#import,`word& — Resume", author: "#import,`word&")
...
#{
doc-header("#import,`word&", ("_", ""), (("https://)-", ")-"), ("https://`?", "`?")))
two-col({
sect("Skills")
skill-line("40%!", "#import中 ̂")
sect("Leadership")
entry("  é^>;", "b+//", "Senior Engineer中", "", "")
bullets((
  rich(((false, "`:*Senior Engineer ̂ %~/////*%"),)),
))
}, {
sect("Projects")
entry("   ̂=40%", "////@", "aSenior Engineerword", "", "")
bullets((
  rich(((false, "{中🚀//^?ع^̂~+*?["),)),
  rich(((false, "\", \"   "),)),
))
