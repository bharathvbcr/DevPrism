...
#set document(title: "#let — Resume", author: "#let")
...
#{
doc-header("#let", ("[", "#import"), (("https://!", "!"), ("https://#let", "#let")))
sect("Summary")
para(rich(((false, "word("),)))
sect("Skills")
skill-line("", "*/Senior Engineer=  !$GPA 3.9")
sect("Experience")
entry("Senior EngineerSenior Engineer}=", "*", "40%中{]/", "", "https://;`")
bullets((
  rich(((false, "é̂word-\\`%```  <`̂.%="),)),
  rich(((false, ";\\́"),)),
  rich(((false, "^word//bअ"),)),
