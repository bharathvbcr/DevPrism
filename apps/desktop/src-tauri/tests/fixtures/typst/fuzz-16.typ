...
skill-line("-$ x $", " /*̂40%̂")
sect("Experience")
entry("é中#let", "&? ", " ;Senior Engineer", "", "https://,$[//#")
bullets((
  rich(((false, ""),)),
  rich(((false, ";*/+🚀([}GPA 3.9(\\अ^```"),)),
))
extra(rich(((false, ">\\#import]"),)))
sect("Projects")
entry("", "=*/", " ", "", "https://\"<&=")
bullets((
  rich(((false, "+@@preview@b#[ع,word??</[="),)),
  rich(((false, "!/*`_<$ x $,अ-.]中#@//.中"),)),
))
extra(rich(((false, "% *"),)))
sect("Leadership")
entry(" |अ)", "@preview中", "%", "", "https:///////*+&")
bullets((
  rich(((false, "́"),)),
  rich(((false, " ?word🚀+40%/*é*a  `\\+  "),)),
  rich(((false, " ́|}#: ```*  GPA 3.9("),)),
))
}
