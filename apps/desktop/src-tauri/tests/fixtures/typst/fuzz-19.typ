...
#set document(title: "<ع`Senior Engineer — Resume", author: "<ع`Senior Engineer")
...
#{
doc-header("<ع`Senior Engineer", ("&+\\", "#:%", "\\,"), (("https://,", ","),))
two-col({
sect("Skills")
skill-line("", "#let;  #import//{")
}, {
sect("Experience")
entry("#let   ", "^]̂", "", "", "")
entry("ع40%]/// ", "", "(~अ", "", "")
bullets((
  rich(((false, "$éword?/>|@preview@é@"),)),
))
extra(rich(((false, "́:"),)))
sect("Projects")
entry("\\a|\\<", "$ x $", "!$ x $", "", "")
