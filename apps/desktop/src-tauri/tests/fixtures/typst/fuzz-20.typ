...
#{
doc-header("; -", ("a:;", "&b"), (("https://GPA 3.9🚀@preview```Senior Engineer", "GPA 3.9🚀@preview```Senior Engineer"),))
sect("Summary")
para(rich(((false, ": //$ x $-"),)))
sect("Skills")
skill-line("", "")
sect("Experience")
entry(" @preview,*/>", "", "40%b Senior Engineer", "", "https://$=")
bullets((
  rich(((false, ".अé+_+ ́ ?_"),)),
))
entry("*#import  ع\\", "$ x $?;", " ?", "", "")
...
entry("", ".", "", "", "")
bullets((
  rich(((false, "#-$ x $#let+.#let  \\ GPA 3.9"),)),
))
sect("Education")
entry("/* @preview", "", "$ x $!#import/*(word", "", "")
bullets((
  rich(((false, "+Senior Engineer>\"/:.+``` }"),)),
  rich(((false, ""),)),
))
extra(rich(((false, "["),)))
}
