...
#set document(title: " अ`#let — Resume", author: " अ`#let")
...
#{
doc-header(" अ`#let", ("Senior Engineer",), (("https://word", "word"), ("https://*/", "*/")))
two-col({
sect("Education")
entry("\\^", "```@preview", "_́=#let*\\", "", "")
bullets((
  rich(((false, "b<"),)),
  rich(((false, ")"),)),
  rich(((false, "){<| _!`(("),)),
...
extra(rich(((false, "🚀."),)))
sect("Leadership")
entry("\"$/Senior Engineer", "%$ x $40%", "````[🚀%_", "", "https:////ع```")
bullets((
  rich(((false, ""),)),
))
}, {
sect("Summary")
para(rich(((false, "Senior Engineer]^अ$ x $́́ |{"),)))
})
}
