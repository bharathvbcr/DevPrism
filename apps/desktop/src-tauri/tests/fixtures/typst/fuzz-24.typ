...
#set document(title: "*/\\.Senior Engineer — Resume", author: "*/\\.Senior Engineer")
...
#{
doc-header("*/\\.Senior Engineer", ("```//", ";", "\\//"), (("https://#let~", "#let~"), ("https://̂", "̂")))
sect("Summary")
para(rich(((false, "🚀́//́<̂ )!&~中```"),)))
sect("Experience")
entry("#import\"中", "", "^word", "@", "https://@b|]+")
bullets((
  rich(((false, "b%^"),)),
  rich(((false, "%\\$b|éb,*>#let"),)),
  rich(((false, ")/*//ع|//$ x $_a40%#^{̂&*/"),)),
))
extra(rich(((false, "|```})"),)))
}
