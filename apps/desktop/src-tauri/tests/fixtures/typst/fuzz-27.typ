...
#set document(title: "中̂$$ — Resume", author: "中̂$$")
...
#{
doc-header("中̂$$", ("Senior Engineer}(", ""), (("https://~", "~"), ("https://,Senior Engineerba#", ",Senior Engineerba#"), ("https://{]", "{]")))
two-col({
sect("Skills")
skill-line("# `", "```{ع ́")
}, {
...
para(rich(((false, "(*/ ["),)))
sect("Projects")
entry(" ,\\", "", "{[/*#import\\", "", "https://word^\"")
bullets((
  rich(((false, " GPA 3.9अ) -!#import ́~@~!|#import"),)),
  rich(((false, "\\#let́\\#a#let@preview| * "),)),
  rich(((false, "$`中`,/*@*///40%\\+,$ <"),)),
))
})
}
