...
entry("ع,^./*", "//!", "", "", "")
bullets((
  rich(((false, "40%é?_}ع.عSenior Engineer"),)),
  rich(((false, "  ,,<Senior Engineer,_́{@preview]#import>"),)),
))
}, {
sect("Experience")
entry("$:\\//=", "\"//%", "́-", "", "https://%_a")
...
entry("^#import//*}éé", "", "$[🚀#let", "", "")
bullets((
  rich(((false, "  #import $ x $40%^<(<= "),)),
  rich(((false, "/*#let//+!̂@preview- >GPA 3.9?$"),)),
))
extra(rich(((false, "["),)))
})
}
