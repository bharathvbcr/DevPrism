...
#set document(title: "#eval(\"1+1\", mode: \"code\") — Resume", author: "#eval(\"1+1\", mode: \"code\")")
...
#{
doc-header("#eval(\"1+1\", mode: \"code\")", ("#eval(\"1+1\", mode: \"code\")", "#eval(\"1+1\", mode: \"code\")", "#eval(\"1+1\", mode: \"code\")"), (("", "#eval(\"1+1\", mode: \"code\")"),))
sect("Summary")
para(rich(((false, "#eval(\"1+1\", mode: \"code\")"),)))
sect("Skills")
skill-line("#eval(\"1+1\", mode: \"code\")", "#eval(\"1+1\", mode: \"code\")")
sect("Experience")
entry("#eval(\"1+1\", mode: \"code\")", "#eval(\"1+1\", mode: \"code\")", "#eval(\"1+1\", mode: \"code\")", "#eval(\"1+1\", mode: \"code\")", "https://#eval(\"1+1\", mode: \"code\")")
bullets((
  rich(((false, "#eval(\"1+1\", mode: \"code\")"),)),
  rich(((false, "prefix #eval(\"1+1\", mode: \"code\") suffix"),)),
))
extra(rich(((false, "#eval(\"1+1\", mode: \"code\")"),)))
}
