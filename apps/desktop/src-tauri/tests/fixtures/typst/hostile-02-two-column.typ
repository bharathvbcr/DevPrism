...
#set document(title: "#import \"@preview/evil:1.0.0\": * — Resume", author: "#import \"@preview/evil:1.0.0\": *")
...
#{
doc-header("#import \"@preview/evil:1.0.0\": *", ("#import \"@preview/evil:1.0.0\": *", "#import \"@preview/evil:1.0.0\": *", "#import \"@preview/evil:1.0.0\": *"), (("", "#import \"@preview/evil:1.0.0\": *"),))
two-col({
sect("Skills")
skill-line("#import \"@preview/evil:1.0.0\": *", "#import \"@preview/evil:1.0.0\": *")
}, {
sect("Summary")
para(rich(((false, "#import \"@preview/evil:1.0.0\": *"),)))
sect("Experience")
entry("#import \"@preview/evil:1.0.0\": *", "#import \"@preview/evil:1.0.0\": *", "#import \"@preview/evil:1.0.0\": *", "#import \"@preview/evil:1.0.0\": *", "https://#import \"@preview/evil:1.0.0\": *")
bullets((
  rich(((false, "#import \"@preview/evil:1.0.0\": *"),)),
  rich(((false, "prefix #import \"@preview/evil:1.0.0\": * suffix"),)),
))
extra(rich(((false, "#import \"@preview/evil:1.0.0\": *"),)))
})
}
