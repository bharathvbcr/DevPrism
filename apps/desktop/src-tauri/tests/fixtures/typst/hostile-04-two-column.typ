...
#set document(title: "*/ #read(\"/x\") /* — Resume", author: "*/ #read(\"/x\") /*")
...
#{
doc-header("*/ #read(\"/x\") /*", ("*/ #read(\"/x\") /*", "*/ #read(\"/x\") /*", "*/ #read(\"/x\") /*"), (("", "*/ #read(\"/x\") /*"),))
two-col({
sect("Skills")
skill-line("*/ #read(\"/x\") /*", "*/ #read(\"/x\") /*")
}, {
sect("Summary")
para(rich(((false, "*/ #read(\"/x\") /*"),)))
sect("Experience")
entry("*/ #read(\"/x\") /*", "*/ #read(\"/x\") /*", "*/ #read(\"/x\") /*", "*/ #read(\"/x\") /*", "https://*/ #read(\"/x\") /*")
bullets((
  rich(((false, "*/ #read(\"/x\") /*"),)),
  rich(((false, "prefix */ #read(\"/x\") /* suffix"),)),
))
extra(rich(((false, "*/ #read(\"/x\") /*"),)))
})
}
