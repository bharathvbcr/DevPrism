...
#set document(title: "// nope #read(\"/x\") — Resume", author: "// nope #read(\"/x\")")
...
#{
doc-header("// nope #read(\"/x\")", ("// nope #read(\"/x\")", "// nope #read(\"/x\")", "// nope #read(\"/x\")"), (("", "// nope #read(\"/x\")"),))
sect("Summary")
para(rich(((false, "// nope #read(\"/x\")"),)))
sect("Skills")
skill-line("// nope #read(\"/x\")", "// nope #read(\"/x\")")
sect("Experience")
entry("// nope #read(\"/x\")", "// nope #read(\"/x\")", "// nope #read(\"/x\")", "// nope #read(\"/x\")", "https://// nope #read(\"/x\")")
bullets((
  rich(((false, "// nope #read(\"/x\")"),)),
  rich(((false, "prefix // nope #read(\"/x\") suffix"),)),
))
extra(rich(((false, "// nope #read(\"/x\")"),)))
}
