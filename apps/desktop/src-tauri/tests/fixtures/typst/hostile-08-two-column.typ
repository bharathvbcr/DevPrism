...
#set document(title: " = INJECTED HEADING  — Resume", author: " = INJECTED HEADING ")
...
#{
doc-header(" = INJECTED HEADING ", ("= INJECTED HEADING", "= INJECTED HEADING", "= INJECTED HEADING"), (("", "= INJECTED HEADING"),))
two-col({
sect("Skills")
skill-line(" = INJECTED HEADING ", " = INJECTED HEADING ")
}, {
sect("Summary")
para(rich(((false, "= INJECTED HEADING"),)))
sect("Experience")
entry(" = INJECTED HEADING ", " = INJECTED HEADING ", " = INJECTED HEADING ", " = INJECTED HEADING ", "https://= INJECTED HEADING")
bullets((
  rich(((false, " = INJECTED HEADING "),)),
  rich(((false, "prefix  = INJECTED HEADING  suffix"),)),
))
extra(rich(((false, "= INJECTED HEADING"),)))
})
}
