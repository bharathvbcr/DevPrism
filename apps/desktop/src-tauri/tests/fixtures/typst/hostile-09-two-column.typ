...
#set document(title: "#show heading: it => [pwned] — Resume", author: "#show heading: it => [pwned]")
...
#{
doc-header("#show heading: it => [pwned]", ("#show heading: it => [pwned]", "#show heading: it => [pwned]", "#show heading: it => [pwned]"), (("", "#show heading: it => [pwned]"),))
two-col({
sect("Skills")
skill-line("#show heading: it => [pwned]", "#show heading: it => [pwned]")
}, {
sect("Summary")
para(rich(((false, "#show heading: it => [pwned]"),)))
sect("Experience")
entry("#show heading: it => [pwned]", "#show heading: it => [pwned]", "#show heading: it => [pwned]", "#show heading: it => [pwned]", "https://#show heading: it => [pwned]")
bullets((
  rich(((false, "#show heading: it => [pwned]"),)),
  rich(((false, "prefix #show heading: it => [pwned] suffix"),)),
))
extra(rich(((false, "#show heading: it => [pwned]"),)))
})
}
