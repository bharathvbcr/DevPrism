...
#set document(title: "#set page(width: 100000pt) — Resume", author: "#set page(width: 100000pt)")
...
#{
doc-header("#set page(width: 100000pt)", ("#set page(width: 100000pt)", "#set page(width: 100000pt)", "#set page(width: 100000pt)"), (("", "#set page(width: 100000pt)"),))
two-col({
sect("Skills")
skill-line("#set page(width: 100000pt)", "#set page(width: 100000pt)")
}, {
sect("Summary")
para(rich(((false, "#set page(width: 100000pt)"),)))
sect("Experience")
entry("#set page(width: 100000pt)", "#set page(width: 100000pt)", "#set page(width: 100000pt)", "#set page(width: 100000pt)", "https://#set page(width: 100000pt)")
bullets((
  rich(((false, "#set page(width: 100000pt)"),)),
  rich(((false, "prefix #set page(width: 100000pt) suffix"),)),
))
extra(rich(((false, "#set page(width: 100000pt)"),)))
})
}
