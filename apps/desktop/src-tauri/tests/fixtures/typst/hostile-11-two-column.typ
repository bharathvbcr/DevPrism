...
#set document(title: "<label> @ref — Resume", author: "<label> @ref")
...
#{
doc-header("<label> @ref", ("<label> @ref", "<label> @ref", "<label> @ref"), (("", "<label> @ref"),))
two-col({
sect("Skills")
skill-line("<label> @ref", "<label> @ref")
}, {
sect("Summary")
para(rich(((false, "<label> @ref"),)))
sect("Experience")
entry("<label> @ref", "<label> @ref", "<label> @ref", "<label> @ref", "https://<label> @ref")
bullets((
  rich(((false, "<label> @ref"),)),
  rich(((false, "prefix <label> @ref suffix"),)),
))
extra(rich(((false, "<label> @ref"),)))
})
}
