...
#set document(title: "$ x^2 / sum_(i=1)^n $ — Resume", author: "$ x^2 / sum_(i=1)^n $")
...
#{
doc-header("$ x^2 / sum_(i=1)^n $", ("$ x^2 / sum_(i=1)^n $", "$ x^2 / sum_(i=1)^n $", "$ x^2 / sum_(i=1)^n $"), (("", "$ x^2 / sum_(i=1)^n $"),))
sect("Summary")
para(rich(((false, "$ x^2 / sum_(i=1)^n $"),)))
sect("Skills")
skill-line("$ x^2 / sum_(i=1)^n $", "$ x^2 / sum_(i=1)^n $")
sect("Experience")
entry("$ x^2 / sum_(i=1)^n $", "$ x^2 / sum_(i=1)^n $", "$ x^2 / sum_(i=1)^n $", "$ x^2 / sum_(i=1)^n $", "https://$ x^2 / sum_(i=1)^n $")
bullets((
  rich(((false, "$ x^2 / sum_(i=1)^n $"),)),
  rich(((false, "prefix $ x^2 / sum_(i=1)^n $ suffix"),)),
))
extra(rich(((false, "$ x^2 / sum_(i=1)^n $"),)))
}
