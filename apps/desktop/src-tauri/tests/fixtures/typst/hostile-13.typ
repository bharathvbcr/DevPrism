...
#set document(title: "\\\\\\\\ \\u{41} \\ — Resume", author: "\\\\\\\\ \\u{41} \\")
...
#{
doc-header("\\\\\\\\ \\u{41} \\", ("\\\\\\\\ \\u{41} \\", "\\\\\\\\ \\u{41} \\", "\\\\\\\\ \\u{41} \\"), (("", "\\\\\\\\ \\u{41} \\"),))
sect("Summary")
para(rich(((false, "\\\\\\\\ \\u{41} \\"),)))
sect("Skills")
skill-line("\\\\\\\\ \\u{41} \\", "\\\\\\\\ \\u{41} \\")
sect("Experience")
entry("\\\\\\\\ \\u{41} \\", "\\\\\\\\ \\u{41} \\", "\\\\\\\\ \\u{41} \\", "\\\\\\\\ \\u{41} \\", "https://\\\\\\\\ \\u{41} \\")
bullets((
  rich(((false, "\\\\\\\\ \\u{41} \\"),)),
  rich(((false, "prefix \\\\\\\\ \\u{41} \\ suffix"),)),
))
extra(rich(((false, "\\\\\\\\ \\u{41} \\"),)))
}
