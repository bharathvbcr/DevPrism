...
#set document(title: "ends with a backslash \\ — Resume", author: "ends with a backslash \\")
...
#{
doc-header("ends with a backslash \\", ("ends with a backslash \\", "ends with a backslash \\", "ends with a backslash \\"), (("", "ends with a backslash \\"),))
two-col({
sect("Skills")
skill-line("ends with a backslash \\", "ends with a backslash \\")
}, {
sect("Summary")
para(rich(((false, "ends with a backslash \\"),)))
sect("Experience")
entry("ends with a backslash \\", "ends with a backslash \\", "ends with a backslash \\", "ends with a backslash \\", "https://ends with a backslash \\")
bullets((
  rich(((false, "ends with a backslash \\"),)),
  rich(((false, "prefix ends with a backslash \\ suffix"),)),
))
extra(rich(((false, "ends with a backslash \\"),)))
})
}
