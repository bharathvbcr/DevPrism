...
#set document(title: "quote \" inside — Resume", author: "quote \" inside")
...
#{
doc-header("quote \" inside", ("quote \" inside", "quote \" inside", "quote \" inside"), (("", "quote \" inside"),))
sect("Summary")
para(rich(((false, "quote \" inside"),)))
sect("Skills")
skill-line("quote \" inside", "quote \" inside")
sect("Experience")
entry("quote \" inside", "quote \" inside", "quote \" inside", "quote \" inside", "https://quote \" inside")
bullets((
  rich(((false, "quote \" inside"),)),
  rich(((false, "prefix quote \" inside suffix"),)),
))
extra(rich(((false, "quote \" inside"),)))
}
