...
#set document(title: "🚀 építész 中文 عربي हिन्दी — Resume", author: "🚀 építész 中文 عربي हिन्दी")
...
#{
doc-header("🚀 építész 中文 عربي हिन्दी", ("🚀 építész 中文 عربي हिन्दी", "🚀 építész 中文 عربي हिन्दी", "🚀 építész 中文 عربي हिन्दी"), (("", "🚀 építész 中文 عربي हिन्दी"),))
sect("Summary")
para(rich(((false, "🚀 építész 中文 عربي हिन्दी"),)))
sect("Skills")
skill-line("🚀 építész 中文 عربي हिन्दी", "🚀 építész 中文 عربي हिन्दी")
sect("Experience")
entry("🚀 építész 中文 عربي हिन्दी", "🚀 építész 中文 عربي हिन्दी", "🚀 építész 中文 عربي हिन्दी", "🚀 építész 中文 عربي हिन्दी", "https://🚀 építész 中文 عربي हिन्दी")
bullets((
  rich(((false, "🚀 építész 中文 عربي हिन्दी"),)),
  rich(((false, "prefix 🚀 építész 中文 عربي हिन्दी suffix"),)),
))
extra(rich(((false, "🚀 építész 中文 عربي हिन्दी"),)))
}
