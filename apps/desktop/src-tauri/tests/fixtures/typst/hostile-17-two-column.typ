...
#set document(title: "é̂̃x — Resume", author: "é̂̃x")
...
#{
doc-header("é̂̃x", ("é̂̃x", "é̂̃x", "é̂̃x"), (("", "é̂̃x"),))
two-col({
sect("Skills")
skill-line("é̂̃x", "é̂̃x")
}, {
sect("Summary")
para(rich(((false, "é̂̃x"),)))
sect("Experience")
entry("é̂̃x", "é̂̃x", "é̂̃x", "é̂̃x", "https://é̂̃x")
bullets((
  rich(((false, "é̂̃x"),)),
  rich(((false, "prefix é̂̃x suffix"),)),
))
extra(rich(((false, "é̂̃x"),)))
})
}
