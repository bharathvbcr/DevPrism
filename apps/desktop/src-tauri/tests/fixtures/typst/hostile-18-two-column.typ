...
#set document(title: "abcd — Resume", author: "abcd")
...
#{
doc-header("abcd", ("abcd", "abcd", "abcd"), (("", "abcd"),))
two-col({
sect("Skills")
skill-line("abcd", "abcd")
}, {
sect("Summary")
para(rich(((false, "abcd"),)))
sect("Experience")
entry("abcd", "abcd", "abcd", "abcd", "https://abcd")
bullets((
  rich(((false, "abcd"),)),
  rich(((false, "prefix abcd suffix"),)),
))
extra(rich(((false, "abcd"),)))
})
}
