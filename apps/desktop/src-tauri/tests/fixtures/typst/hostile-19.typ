...
#set document(title: "abcdrowssapdef — Resume", author: "abcdrowssapdef")
...
#{
doc-header("abcdrowssapdef", ("abcdrowssapdef", "abcdrowssapdef", "abcdrowssapdef"), (("", "abcdrowssapdef"),))
sect("Summary")
para(rich(((false, "abcdrowssapdef"),)))
sect("Skills")
skill-line("abcdrowssapdef", "abcdrowssapdef")
sect("Experience")
entry("abcdrowssapdef", "abcdrowssapdef", "abcdrowssapdef", "abcdrowssapdef", "https://abcdrowssapdef")
bullets((
  rich(((false, "abcdrowssapdef"),)),
  rich(((false, "prefix abcdrowssapdef suffix"),)),
))
extra(rich(((false, "abcdrowssapdef"),)))
}
