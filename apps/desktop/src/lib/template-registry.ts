...
% Contact-line helpers. Deliberately plain typography rather than an icon font:
% fontawesome5 aborts XeTeX under the bundled Tectonic engine, so icons would
% make this template uncompilable out of the box.
\\newcommand{\\cvfield}[2]{{\\color{primary}\\bfseries #1:}\\;#2}
\\newcommand{\\cvdot}{{\\color{lightgray}\\textbullet}\\quad}
...
\\begin{center}
  ...
  {\\small
    \\cvfield{Email}{\\href{mailto:a.chen@stanford.edu}{a.chen@stanford.edu}} \\cvdot
    \\cvfield{Phone}{+1 (650) 555-0142} \\cvdot
    \\cvfield{Location}{Stanford, CA}\\\\[4pt]
    \\cvfield{Web}{\\href{https://alexchen.io}{alexchen.io}} \\cvdot
    \\cvfield{GitHub}{\\href{https://github.com/alexchen}{github.com/alexchen}} \\cvdot
    \\cvfield{LinkedIn}{\\href{https://linkedin.com/in/alexchen}{linkedin.com/in/alexchen}} \\cvdot
    \\href{https://scholar.google.com/citations?user=XXXXX}{Google Scholar}
  }
\\end{center}
