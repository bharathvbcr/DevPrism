...
This project is indexed by GitNexus as **docs** (12 symbols, 10 relationships, 0 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
- Canonical map: `GITNEXUS_MAP.md`
- Use this as the source of truth for repo ownership references.
